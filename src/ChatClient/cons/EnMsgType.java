...
public enum EnMsgType {
    EN_MSG_LOGIN, //用户登录消息
    EN_MSG_LOGIN_SUCC, //用户登录成功
    EN_MSG_LOGIN_FAIL, //用户登录失败
    EN_MSG_REGISTER, //用户注册
    EN_MSG_REGISTER_SUCC, //用户注册成功
    EN_MSG_REGISTER_FAIL, //用户注册失败
    ...
    EN_MSG_CREATE_GROUP,  //创建群聊
    EN_MSG_CREATE_GROUP_SUCC,  //创建群聊成功
    EN_MSG_CREATE_GROUP_FAIL,  //创建群聊失败
